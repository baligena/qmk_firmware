...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /*[0] = LAYOUT_ergodox_pretty(*/
	...
	/*LT(1      , KC_GRAVE)    , KC_QUOTE , LALT(KC_LSHIFT) , KC_LEFT , KC_RIGHT , KC_DOWN 				 ,KC_UP  , KC_LBRACKET , KC_RBRACKET , MO(1)    ,*/
  ...
  [0] = LAYOUT_ergodox_pretty(
	KC_ESCAPE,  KC_1,   KC_2,     KC_3,         KC_4,       KC_5,         KC_F14						,KC_RIGHT , KC_6        , KC_7        , KC_8     , KC_9       , KC_0             , KC_MINUS  ,
	KC_TAB,     KC_Q,   KC_W,     KC_E,         KC_R,       KC_T,         KC_F23						 , TG(1)    , KC_Y        , KC_U        , KC_I     , KC_O       , KC_P             , KC_BSLASH ,
	KC_BSPACE , KC_A         , KC_S     , KC_D            , KC_F    , KC_G     , KC_H					 , KC_J     , KC_K        , KC_L        , LT(2     , KC_SCOLON) , LGUI_T(KC_QUOTE) ,
	KC_LSHIFT , LCTL_T(KC_Z) , KC_X     , KC_C            , KC_V    , KC_B     , KC_HYPR				 , KC_MEH   , KC_N        , KC_M        , KC_COMMA , KC_DOT     , RCTL_T(KC_SLASH) , KC_RSHIFT ,
	LT(1      , KC_GRAVE)    , KC_QUOTE , LALT(KC_LSHIFT) , KC_LEFT , KC_RIGHT , KC_DOWN 				 ,KC_UP  , KC_LBRACKET , KC_RBRACKET , MO(1)    ,
															 LALT_T(KC_APPLICATION),KC_LGUI,			KC_LALT,LCTL_T(KC_ESCAPE),
